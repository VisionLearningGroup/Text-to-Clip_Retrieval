...
__C.TRAIN.CAPTION_FG_THRESH = 0.7     
...
__C.TRAIN.CAPTION_TOP_N = 64  
# Proposal height and width both need to be greater than RPN_MIN_SIZE (at orig image scale)
__C.TRAIN.RPN_MIN_SIZE = 8   
__C.TRAIN.CAPTION_MIN_SIZE = 0   
...
__C.TEST.CAPTION_TOP_N = 64  
# Proposal height and width both need to be greater than RPN_MIN_SIZE (at orig image scale)
__C.TEST.RPN_MIN_SIZE = 8         
__C.TEST.CAPTION_MIN_SIZE = 0   
...
__C.MAX_WORDS = 20
__C.LSTM_BATCH_SIZE = 20
__C.MAX_SENTENCE_LSTM = 20
__C.RETRIEVAL_BATCH_SIZE = 128
