...
from roi_data_layer.minibatch_caption import get_minibatch
import numpy as np
import yaml
from multiprocessing import Process, Queue

class RoIDataLayer(caffe.Layer):
    """Text-to-Clip Retrieval data layer used for training."""
    ...
    def setup(self, bottom, top):
        ...
        if cfg.TRAIN.HAS_RPN:
            ...
            idx += 1
            ### hold the caption information
            top[idx].reshape(1, 3, cfg.MAX_WORDS)
            self._name_to_top_map['gt_captions'] = idx
            idx += 1
        else: # not using RPN
